...
void WorldConfig::BuildConfigCache()
{
    ...
    // RebornWOW S.7.0: the stock 3.3.5 GlueXML displays ten characters, but the
    // protocol count is an uint8.  Our matching paged GlueXML safely exposes up
    // to fifty characters while preserving the stock default of ten.
